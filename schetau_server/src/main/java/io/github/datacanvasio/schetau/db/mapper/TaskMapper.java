...
public interface TaskMapper {
    ...
    int insert(@Param("model") Task model);

    int update(@Param("model") Task model);

    int updateWaitingToExpiredByTime(@Param("time") long time);

    int updateWaitingToReadyBySignals();
}
